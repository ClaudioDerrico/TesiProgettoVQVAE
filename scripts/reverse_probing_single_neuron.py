...
Uso:
    python scripts/reverse_codebook_probing_single_neuron.py
"""
...
WANDB_RUN_NAME = f"reverse-context-1neuron-{datetime.now().strftime('%m%d-%H%M')}"
...
def main():
    print("="*70)
    print("🔬 REVERSE CONTEXT PROBING: Singolo Neurone (Tracce)")
    print("="*70)
    print(f"\n📋 Configurazione:")
    ...
    wandb.init(
        ...
        config={
            ...
            "experiment_type": "reverse_context_multiple",
            **MODEL_CONFIG
        },
        tags=["reverse-context-probing", "single-neuron", "traces", "multiple-center", "code-7-center"]
    )
