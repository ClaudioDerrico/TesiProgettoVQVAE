#!/usr/bin/env python3
"""
Visualizzazione Scatter: Distanza vs Differenza di Ampiezza DUAL CONSTRAINED
...
Uso:
    python scripts/plotta_dati_distanza_ampiezza_duale_constrained.py
"""
...
# ============================================================================
# ⚙️ CONFIGURAZIONE - MODIFICA QUI PER CAMBIARE DIRECTORY
# ============================================================================

# ✅ MODIFICA QUI: Directory dove sono salvati i dati per modelli constrained
AMPLITUDE_PAIRS_DIR = "ampiezza_coppie_dual_constrained/coppie codice"

# Configurazione W&B
WANDB_PROJECT = "ampiezza_vs_distanza_duale_constrained_completi"
WANDB_RUN_NAME = "amplitude-difference-scatter-dual-constrained-1024pts"
USE_WANDB = True
...
def load_all_amplitude_pair_files(pairs_dir):
    ...
    print(f"✅ Caricati {len(all_pairs_data)} file di ampiezze CONSTRAINED")
...
def extract_amplitude_data_dual(all_pairs_data):
    """
    Estrae TUTTE le singole coppie con dati di ampiezza e distanza (DUAL CONSTRAINED)
    ...
    print(f"\n✅ Estratte {len(data['base_codes'])} coppie totali CONSTRAINED")
...
def plot_amplitude_difference_scatter_dual(data, use_wandb=False):
    """
    Crea 4 scatter plots: Distanza vs Differenza Ampiezza (DUAL CONSTRAINED)
    ...
    # Finalizzazione
    # ========================================================================
    plt.suptitle('Distance-Amplitude Relationships: All Code Pairs DUAL CONSTRAINED', 
    ...
    if use_wandb:
        wandb.log({
            "amplitude_difference_scatter_dual_constrained": wandb.Image(fig)
        })
...
def print_detailed_statistics(data, correlations, correlations_by_type):
    ...
    print(f"\n{'='*70}")
    print("📊 STATISTICHE DESCRITTIVE (DUAL CONSTRAINED)")
    print(f"{'='*70}")
...
def main():
    print("="*70)
    print("📊 SCATTER PLOT: DISTANZA vs AMPIEZZA DUAL CONSTRAINED")
    print("="*70)
    ...
    try:
        ...
        if USE_WANDB:
            ...
            wandb.init(
                ...
                name=WANDB_RUN_NAME,
                config={
                    "analysis_type": "amplitude_difference_scatter_dual_constrained",
